...
void loop() {
	...
	if (millis() - lastCheck > CHECK_TO) {
		...
		lastCheck = millis();
		String publish =
			String::format("{\"VEHICLE_SPEED\":%f,\"AMBIENT_AIR_TEMPERATURE\":%f,\"CONTROL_MODULE_VOLTAGE\":%f,\"FUEL_TANK_LEVEL_INPUT\":%f,\"CHARGE_AMPS_IN\":%f,\"CHARGER_VOLTS_IN\":%f,\"EXTENDED_HYBRID_BATTERY_PACK_REMAINING_LIFE\":}",
										 GCP.VEHICLE_SPEED,
